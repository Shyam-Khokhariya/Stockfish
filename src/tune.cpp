...
template<> void Tune::Entry<Score>::init_option() {
  make_option("m" + name, mg_value_inverse(value), range);
  make_option("e" + name, eg_value_inverse(value), range);
}

template<> void Tune::Entry<Score>::read_option() {
  if (Options.count("m" + name))
      value = make_score(int(Options["m" + name]), eg_value_inverse(value));

  if (Options.count("e" + name))
      value = make_score(mg_value_inverse(value), int(Options["e" + name]));
}
